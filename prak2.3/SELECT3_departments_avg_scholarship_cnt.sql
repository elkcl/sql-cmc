...
FROM departments
	 ...
	 JOIN enrollments ON (enrollments.group_id = "groups".group_id AND enrollments.tuition_type = 'бюджет')
GROUP BY department_id, department, major_id, major
ORDER BY department_id, major_id, cnt DESC;